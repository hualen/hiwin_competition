...
open_bag =  [   
                # BASE 30 TOOL 10
                [155.948, 198.464, 111.683, 158.365, 18.949, -8.696],
                [356.067, 198.464, 111.683, 158.365, 18.949, -8.696],
                [511.463, 198.464, 111.683, 158.365, 18.949, -8.696],
                [511.463, 268.12, 111.683, 158.365, 18.949, -8.696],
                [511.463, 268.12, 211.95, 158.365, 18.949, -8.696],
                [511.462, 216.605, 264.391, 158.365, 18.949, -8.696],
                [302.169, 250.605, 342.391, 158.365, 18.949, -8.696], #抬高中繼點
                
                [94.269, 285.991, 420.882, 158.366, 18.95, -8.696],  # [94.269, 285.991, 410.882, 158.366, 18.95, -8.696]
                [0.792, 285.991, 420.883, 158.365, 18.949, -8.696], #
                [0.792, 285.991, 380.309, 158.365, 18.949, -8.696],
                [0.792, 257.941, 380.309, 158.365, 18.949, 1.696],
                [0.792, 257.941, 252.876, 158.365, 18.949, 1.696],
            ]   

# 收袋點位
out_bag =   [
                [416.255, 200.401, 428.322, 158.363, 18.948, -8.696],
                [416.255, 200.401, 280.634, 158.363, 18.948, -8.696], 
                [416.616, 280.918, 280.348, 158.362, 18.947, -8.696], # 前推
                [416.616, 280.918, 382.847, 158.362, 18.947, -8.696], 
                [446.905, 291.338, 395.194, 158.363, 18.948, -8.696],
                [145.031, 221.175, 395.194, 158.363, 18.948, -8.696],
                [138.279, 270.897, 453.266, -169.409, 20.632, 2.475],
                [-69.019, 270.897, 453.266, -169.409, 20.632, 2.475],
                [-79.019, 270.897, 401.141, -169.409, 20.632, 2.475],
                [-79.019, 240.379, 401.141, -169.409, 20.632, 78.758],
                [47.042, 275.482, 254.341, 153.697, 9.848, 68.690], #-169.409, 20.632, 78.758
            ]
standby_pass = [40.792, 153.685, 252.876, 158.365, 18.949, 1.696]
standby = [232.82, 260.402, 428.323, 158.364, 18.948, -8.696]

tea =   [
            [241.607+tea_cali[0], 365.833+tea_cali[1], 417.635, 158.364, 18.948, -8.696],
            [241.607+tea_cali[0], 365.833+tea_cali[1], 391.623, 158.364, 18.948, -8.696],
            [241.607+tea_cali[0], 196.554+tea_cali[1], 389.623, 158.364, 18.948, -8.696],
            [241.607+tea_cali[0], 379.157+tea_cali[1], 391.623, 158.364, 18.948, -8.696],
            [241.607+tea_cali[0], 364.833+tea_cali[1], 391.623, 158.364, 18.948, -8.696],
            [241.607+tea_cali[0], 364.833+tea_cali[1], 417.635, 158.364, 18.948, -8.696]
        ]
puf =   [#關到底
            [362.118+puf_cali[0], 366.628+puf_cali[1], 424.750, 158.368, 18.949, -8.713],
            [362.118+puf_cali[0], 366.628+puf_cali[1], 389.067, 158.368, 18.949, -8.713],
            [362.119+puf_cali[0], 189.153+puf_cali[1], 389.067, 158.369, 18.949, -8.714],
            [362.119+puf_cali[0], 367.628+puf_cali[1], 389.067, 158.369, 18.949, -8.714],
            [362.119+puf_cali[0], 367.628+puf_cali[1], 424.750, 158.369, 18.949, -8.714]
        ]
egg =   [
            [150.546+egg_cali[0], 366.045+egg_cali[1], 416.444, 158.36, 18.949, -8.691],
            [150.546+egg_cali[0], 366.045+egg_cali[1], 389.934, 158.36, 18.949, -8.691],
            [150.700+egg_cali[0], 290.027+egg_cali[1], 389.297, 158.363, 18.947, -8.725],
            [150.546+egg_cali[0], 367.045+egg_cali[1], 389.934, 158.36, 18.949, -8.691],
            [150.546+egg_cali[0], 367.045+egg_cali[1], 416.444, 158.36, 18.949, -8.691],
        ]
finish  =   [
                ...
                [-15.62, 135.419, 350.178, -173.967, 25.277, 46.986],
                [-15.62, 293.577, 350.178, -173.967, 25.277, 46.986],
                [-15.62, 234.74, 350.178, -173.967, 25.277, 46.986],
            ]
    ...
    def _state_machine(self, state: States) -> States:
        ...
        #===================================================
            ...
            for i in range(0,4):
                ...
                res = self.move_PTP(open_bag[11],False)
