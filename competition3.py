...
open_bag =  [   
                # BASE 30 TOOL 10
                [356.067, 193.464, 171.683, 158.365, 18.949, -8.696],  # 轉治具並下降
                [511.463, 193.464, 171.683, 158.365, 18.949, -8.696],  # 壓袋子
                [511.463, 278.12, 171.683, 158.365, 18.949, -8.696],   # 壓袋子位置前推
                [511.463, 278.12, 221.95, 158.365, 18.949, -8.696],    # 往上一點
                [491.462, 216.605, 254.391, 158.365, 18.949, -8.696],  # 碰到繩子洞口  
                [254.169, 250.605, 354.391, 158.365, 18.949, -8.696],  # 抬高中繼點
                [ 94.269, 292.991, 420.882, 158.366, 18.95, -8.696],   # 到原子筆口前 [94.269, 285.991, 410.882, 158.366, 18.95, -8.696]
                [-10.792, 292.991, 420.883, 158.365, 18.949, -8.696],  # 進原子筆
                [-10.792, 292.991, 380.309, 158.365, 18.949, -8.696],  # 下降一點
...
out_bag =   [
                ...
                [
                    [ 46.189, 300.141, 454.359, 158.362, 18.952, 91.516], # 進入原子筆 8-1
                    [-25.189, 300.141, 438.359, 158.362, 18.952, 91.516], # 進入原子筆 8-2
                    [-96.189, 300.141, 438.359, 158.362, 18.952, 91.516]  # 進入原子筆 8-
                ], 
                [-96.189, 295.636, 391.56, 158.362, 18.952, 91.516],  # 往下一點
...
tea =   [
            ...
            [239.607+tea_cali[0], 362.833+tea_cali[1], 394.623+tea_cali[2], 158.364, 18.948, -8.696],
            [239.607+tea_cali[0], 362.833+tea_cali[1], 422.635, 158.364, 18.948, -8.696]
        ]
    ...
    def _state_machine(self, state: States) -> States:
        ...
        #===================================================
            ...
            for i in range(0,4):
                ...
                self.BStop()
                res = self.exit_move_PTP(out_bag[7][0],DEBUG_MODE) # 進入原子筆
                self.BStop()
                res = self.exit_move_PTP(out_bag[7][1],DEBUG_MODE) # 進入原子筆
                self.BStop()
                res = self.exit_move_PTP(out_bag[7][2],DEBUG_MODE) # 進入原子筆
                self.BStop()
