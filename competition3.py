...
egg =   [
            ...
            [150.700+egg_cali[0], 284.027+egg_cali[1], 392.297+egg_cali[2], 158.363, 18.947, -8.725],
    ...
    def _state_machine(self, state: States) -> States:
        ...
        #===================================================
            ...
            for i in range(0,4):
                ...
                self.BStop()
                res = self.move_PTP(out_bag[7][0],DEBUG_MODE) # 進入原子筆
                self.BStop()
                res = self.move_PTP(out_bag[7][1],DEBUG_MODE) # 進入原子筆
                self.BStop()
                res = self.move_PTP(out_bag[7][2],DEBUG_MODE) # 進入原子筆
                self.BStop()
